  ...
  return (
    <main className="site-shell">
      ...
      <section className="principles-section" id="city">
        ...
        <div className="principle-grid"><div className="principle-card card-photo card-safety"><img src="/yatrigo-safety-card-search.jpg" alt="A commuter walking safely from a city bus toward a lit station entrance" /><div className="card-photo-overlay" /><div className="card-photo-copy"><ShieldCheck size={22} /><span>SAFETY SHIELD</span><h3>Move with a little more certainty.</h3><p>Smart stop alerts and planned safety tools for solo journeys and late connections.</p></div></div><div className="principle-card card-image"><img src="https://images.unsplash.com/photo-1519501025264-65ba15a82390?auto=format&fit=crop&w=1200&q=82" alt="An abstract network of city routes at night" /><div><span>OFFLINE-FIRST</span><h3>The signal stays with you.</h3></div></div><div className="principle-card card-photo"><img src="/yatrigo-offline-card.png" alt="A commuter waiting beside a city bus stop after rain" /><div className="card-photo-overlay" /><div className="card-photo-copy"><WifiOff size={22} /><span>LOW DATA / HIGH CLARITY</span><h3>Useful, even between signals.</h3><p>Cached routes, stops, and last-known data keep the journey legible when the network is not.</p></div></div></div>
      </section>
